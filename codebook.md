...
Codebook
========
Codebook was generated on 2014-08-24 19:55:35 during the same process that generated the dataset. See `run_analysis.md` or `run_analysis.html` for details on dataset creation.
...
```r
f <- file.path(full_wd, "DatasetHumanActivityRecognitionUsingSmartphones.txt")
